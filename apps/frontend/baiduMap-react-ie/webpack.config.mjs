...
const baseConfig = env => {
  ...
  return {
    entry: [
      'core-js/stable', // 添加core-js polyfill
      'core-js/features/array/from', // IE10 不支持 Array.from
      'core-js/features/promise',
      'regenerator-runtime/runtime', // 添加生成器运行时
      ...
      rules: [
        {
          ...
          // exclude: /node_modules\/(?!(@eggshell\/unocss-ui-ie|hash-wasm|zod|react-is|events|ansi-html-community|@glideapps\/glide-data-grid)\/).*/,
          use: [
            {
              loader: 'babel-loader',
              options: {
                presets: [
                  [
                    '@babel/preset-env',
                    {
                      ...
                      corejs: 3,
                      // targets: "IE 10"
                      targets: false // 强制从.browserslistrc读取配置
                    }
                  ],
                  [
                    '@babel/preset-react',
                    {
                      runtime: 'automatic'
                      // importSource: '@welldone-software/why-did-you-render' // 更兼容的react运行时
                    }
                  ],
    ...
    optimization: {
      ...
      splitChunks: {
        ...
        cacheGroups: {
          ...
          // thirdPartyBase: {
          //   test: /[\\/]node_modules[\\/](hash-wasm|zod|react-is|events|ansi-html-community|@glideapps\/glide-data-grid)[\\/]/,
          //   name: 'third-party-base',
          //   priority: 15,
          //   reuseExistingChunk: true
          // },
          // defaultVendors: {
