...
//     const internalFileListRef = useRef<UploadFile[]>(fileList || defaultFileList || []);
...
//         // 显示上传开始的状态消息
//         setStatusMessage({ text: `正在上传: ${file.name}`, type: 'info' });
...
//                 setStatusMessage({ text: `${file.name} 上传成功！`, type: 'success' });
//               },
//               onError: (error: unknown) => {
//                 updateFileStatus(file.uid, { status: 'error', error });
//                 setStatusMessage({ text: `${file.name} 上传失败！`, type: 'error' });
//               }
//             });
//           }
//         } else {
//           // 模拟上传进度
//           simulateUpload(file.uid, file.name);
//         }
//       });
//     };
...
//     // 模拟上传进度
//     const simulateUpload = (uid: string, fileName: string) => {
//       let percent = 0;
...
//             setStatusMessage({ text: `${fileName} 上传成功！`, type: 'success' });
//           }, 800);
//         } else {
//           updateFileStatus(uid, { percent });
//           setStatusMessage({ text: `${fileName} 上传中: ${percent}%`, type: 'info' });
//         }
...
//             )}
//           >
//             {statusMessage.type === 'info' && <span className="i-carbon-information mr-1"></span>}
//             {statusMessage.type === 'success' && (
//               <span className="i-carbon-checkmark-filled mr-1"></span>
//             )}
//             {statusMessage.type === 'error' && <span className="i-carbon-error-filled mr-1"></span>}
//             {statusMessage.text}
//           </div>
//         )} */}
