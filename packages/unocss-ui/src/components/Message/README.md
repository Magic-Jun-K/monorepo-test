...
```jsx
import { message } from '@eggshell/unocss-ui';
...
```jsx
import { useMessage } from '@eggshell/unocss-ui';
...
```ts
import { MessageConfig, MessageConfigBase, MessageInstance } from '@eggshell/unocss-ui';
```
