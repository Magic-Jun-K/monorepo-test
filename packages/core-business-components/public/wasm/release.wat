(module
 ...
 (type $8 (func (param i32 f64 f64 f64 f64) (result i32)))
 ...
 (data $11 (i32.const 1616) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\01\1a")
 ...
 (func $assembly/map-points/generateRandomPoints (param $0 i32) (param $1 f64) (param $2 f64) (param $3 f64) (param $4 f64) (result i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
  (local $8 i32)
  ...
  block $folding-inner1
   ...
   i64.store
   global.get $~lib/memory/__stack_pointer
   block $__inlined_func$~lib/typedarray/Float64Array#constructor$2 (result i32)
    local.get $0
    i32.const 1
    i32.shl
    local.set $8
    ...
    block $folding-inner0
     ...
     global.set $~lib/memory/__stack_pointer
     local.get $5
     br $__inlined_func$~lib/typedarray/Float64Array#constructor$2
    end
    br $folding-inner1
   end
   local.tee $5
